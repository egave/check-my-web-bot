...
start = 
  Welcome, {$name}, to the {-project-name}! This Bot sends a Telegram notification when a Web Resource being monitored fails the check to be performed. Send /help for a list of available commands. 
